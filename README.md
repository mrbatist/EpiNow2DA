...
# EpiNow2DA: Estimate real-time case counts and time-varying epidemiological parameters
...
``` r
install.packages("EpiNow2", repos = "https://github.com/mrbatist/EpiNow2DA.git")
```
